...
function createRecommendation() {
   if (acresBox.value <= 5000) { // 5000 acres or less, no crop test needed
       //window.alert("After first if clauses:" + acresBox.value);
       //console.log("After first if clauses:" + acresBox.value);
      if (monthsBox.value >= 10) { // 10+ months of farming per year
          //window.alert("After second if clauses: " + monthsBox.value);
